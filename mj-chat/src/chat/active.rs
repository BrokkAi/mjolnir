...
impl ActiveChat {
    ...
    fn run_turn_review(&mut self, intent: crate::chat::TurnReviewRequest) {
...
fn prompt_title_line(
    chat: &ChatState,
    prompt_area: Rect,
) -> (Line<'static>, Option<Line<'static>>, Vec<(&'static str, Rect)>) {
...
mod tests {
    ...
    fn capture_chat_preview() {
        ...
        chat.turn_started_at_epoch_seconds =
            Some(mj_core::clock::epoch_seconds().saturating_sub(42));
