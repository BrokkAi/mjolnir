...
pub enum UiEvent {
    ...
    /// Latest Codex subscription-quota scrape (or an unavailable reason). Like
    /// `ClaudeUsage`, this is UI-only side-channel data scraped from Codex's
    /// rollout logs; it never goes through ACP.
