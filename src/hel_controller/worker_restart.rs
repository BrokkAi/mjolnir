...
use crate::hel_targets::{self, CommandExecutor, CommandSpec};
use crate::hel_worker::RelayExecutionState;
...
impl Controller {
    ...
    pub async fn upgrade_session_worker(
        ...
        let installed = crate::hel_worker_runtime::worker_executable_digest(&binary)?;
