...
- [ ] Milestone 0: null label
- [ ] Milestone 1: scan cache, cheaper parse, throttled publish, notice on Import tab
- [ ] Milestone 2: per-tab hit counts
- [ ] Milestone 3: scrollable preview
- [ ] Milestone 4: transcript hits
- [ ] Milestone 5: search pending/complete state
