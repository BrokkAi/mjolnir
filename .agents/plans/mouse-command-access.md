...
- [ ] Deliver the validated changes on master to origin/master; preserve any concurrent upstream work.
...
Live seed 914 passed all 12 assertions at `target/reliability-artifacts/mouse-commands-seed-914-70015/`. The tested CLI SHA-256 was `6fc309b056325ea91d0ec08de2f141ba16f0965e9ce951ee11bb04dcfd55d57f`. Logs are in `target/mouse-full-tests.log`, `target/mouse-clippy.log`, and the corresponding docs/live logs. The deterministic screenshot generator refreshed the four documentation SVGs. Do not commit generated build output.
