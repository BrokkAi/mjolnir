//! Historical migrations retained so upgrades never require an intermediate release.
//! These are the original revision 2–33 steps, including their structural repairs.
//! New stores use baseline.sql; existing stores keep the full forward path.
