...
fn default_import_target_id(config: &Config) -> String {
    config
        .targets
...
fn raw_import_target_id(config: &Config) -> Option<String> {
...
fn default_profile(config: &Config, harness: HarnessKind, home: &Path) -> String {
