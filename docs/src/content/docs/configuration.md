...
palette (**F2**) also provides **Manage agent profiles**, **Manage machines**,
and **Manage runtimes**. No setup command or file editing is required. **Detect machine**
on the **Agent Profiles** page can import existing agent accounts for review.
