...
| Optional agent routes | Add Claude, Kimi, OpenCode, or a custom ACP server without replacing the Codex-first workflow |
...
Codex is the recommended primary, not a lock-in boundary. Claude, Kimi, OpenCode,
