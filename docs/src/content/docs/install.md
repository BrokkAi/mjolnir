...
Claude, Kimi, OpenCode, and custom ACP servers are optional. Configure them after
the Codex path works if you want alternative primary, subagent, or review
routes. Mjolnir can install Kimi, OpenCode, and supported binary agents from the ACP
registry.
