...
| Mid-turn steering | Queue a correction while a supported Claude session is streaming, then use Cancel or Stop to inject the oldest queued correction into that turn |
