...
/// The built-in ACP servers this machine has usable credentials for. Drives
/// the default team, which only applies when both providers are signed in.
pub fn signed_in_sources() -> Vec<String> {
    [
