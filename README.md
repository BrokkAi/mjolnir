...
team it picked: **Claude coder + Codex reviewer** when both providers are
signed in and enabled, otherwise a team you choose. Press **Ctrl+Tab** to
switch teams later, or open the **Team** tab in `/mjconfig`. Team, model, and
adapter changes apply to a new session.
